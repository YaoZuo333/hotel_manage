<template>
    <div class="booking-detail">
      ...
      <div class="detail-body row">
        ...
        <div class="detail-type">
          <section class="col-md-6">人数：{{this.bookingRoom.peoples}}人</section>
        </div>
...
<script>
  ...
  import {postOrder} from "../../api";
    export default {
      ...
      methods:{
          async addOrder(){
            const result = await postOrder(this.bookingRoom.type,this.bookingRoom.start,this.bookingRoom.end,this.userInfo.id,this.bookingRoom.price,this.bookingRoom.number,this.bookingRoom.totalPrice,this.others,this.bookingRoom.peoples);
            console.log(result);
