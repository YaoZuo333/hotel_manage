    ...
    <div class="booking-select container">
      ...
      <div class="select-body row">
        <section class="col-md-2 type">
          <strong>
            <a href="javascript:void(0)" style="font-size: 30px">{{this.bookingRoom.type}}</a>
          </strong>
        </section>
        <section class="col-md-2 select-img">
          <img :src=this.bookingRoom.img width="150px">
        </section>
        <section class="select-price col-md-2" style="font-size: 25px">
          价格：￥{{this.bookingRoom.price}}
        </section>
        <section class="select-number col-md-2" style="font-size: 25px">
        ...
        <section class="select-total col-md-3" style="font-size: 25px">
