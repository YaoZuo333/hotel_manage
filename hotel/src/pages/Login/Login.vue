<template>
    <div class="login_index">
      ...
      <div class="login-header-title">
        <a href="javascript:;" :class="{current: loginMode}" @click="dealLoginMode(true)" style="font-size: 30px">验证码登录</a>
        <a href="javascript:;" :class="{current: !loginMode}" @click="dealLoginMode(false)" style="font-size: 30px">密码登录</a>
      </div>
