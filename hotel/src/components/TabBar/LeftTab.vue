<template>
    <div class="leftTab">
      <ul class="leftTab-list">
        <li :class="{active:show == 0}" @click="tabbarSelect('/home',0)">
          首页
        </li>
        <li :class="{active:show == 1}" @click="tabbarSelect('/introduction',1)">
          酒店介绍
        </li>
        ...
        <li :class="{active:show == 4}" @click="tabbarSelect('/membermanage',4)" v-if="this.userInfo.user_position =='管理员'">
          客户信息
        </li>
        <li :class="{active:show == 4}" @click="tabbarSelect('/member',4)" v-else>
          个人信息
        </li>
